...
def args_parser():
    ...
    parser.add_argument('--local_bs', type=int, default=500, help="local batch size: B")     # B 用于客户机更新的批处理大小
    parser.add_argument('--local_ep', type=int, default=5, help="the number of local epochs: E")    # E 每个客户机在每轮上通过其本地数据集执行的训练次数 默认值是5（default=5）
    ...
    parser.add_argument('--L', type=int, default=10, help='non i.i.d ')
    # parser.add_argument('--iid', action='store_true', help='whether i.i.d or not')  #独立同分布
    # parser.add_argument('--L', type=int, default=5, help='non i.i.d ')
